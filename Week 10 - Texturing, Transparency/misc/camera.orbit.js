function OrbitCamera(input) {
	...
	this.getPosition = function () {
		...
		position.x = this.cameraWorldMatrix.getElement(0, 3);
		position.y = this.cameraWorldMatrix.getElement(1, 3);
		position.z = this.cameraWorldMatrix.getElement(2, 3);
		position.w = this.cameraWorldMatrix.getElement(3, 3);
		return position;
	}
